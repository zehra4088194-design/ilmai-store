...
const mapAddress = (a: any): Address => ({ id: a.id, label: a.label ?? undefined, fullName: a.full_name, phone: a.phone, line1: a.line1, line2: a.line2 ?? undefined, city: a.city, state: a.state ?? undefined, postalCode: a.postal_code ?? undefined, country: a.country, isDefault: a.is_default ?? false });
