...
export function ProductReviews({ productId, reviews }: { productId: string; reviews: Review[] }) {
  ...
  return <div>
    ...
    <h2 className="mt-8 text-2xl font-black tracking-[-.02em] text-[#0B1D3A]">Customer Reviews</h2>

    <div className="mt-6 grid gap-4">
      {reviews.length === 0 && <p className="text-sm text-[#64748B]">No reviews yet — be the first to share your thoughts.</p>}
