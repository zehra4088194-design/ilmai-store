...
export default async function AdminSellersPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl p-6 lg:p-10">
      <p className="text-xs font-bold uppercase tracking-[.2em] text-[#0F766E]">Marketplace control</p>
      ...
      <p className="mt-3 max-w-2xl text-sm text-[#64748B]">
        ...
        <Link href="/admin/products" className="font-bold text-[#0F766E]">Products</Link>.
      </p>
